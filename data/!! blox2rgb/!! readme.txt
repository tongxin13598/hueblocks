...
if you didn't read README.md for some reason, here's what you need to run these scripts:
- Python 3.8 on newer (sorry Windows XP users!)
- PILLOW module (run "pip install pillow" in CMD.EXE)


==== OKAY, HOW TO USE IT?
[1] put your blockset's directory to the same directory where blox2rgb is stored
[2] run blox2rgb (if it doesn't work, make sure you've installed PILLOW and use at least Python 3.8)
